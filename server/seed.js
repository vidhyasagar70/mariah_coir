import { dbQuery, generateUuid, initDb } from './db.js';
...
export async function seedData() {
  ...
  const suppliers = [
    ...
    {
      id: 'SUP-005',
      name: 'Pollachi Coir Fiber & Husk',
      category: 'Raw Material',
      company_name: 'Pollachi Agro Coir Pvt Ltd',
      contact_person: 'P. Arumugam',
      contact_number: '+91 99441 77650',
      status: 'Inactive'
    }
  ];
  ...
  // 2. Insert Supplier Vehicles & Rates
  const vehicles = [
    ...
    { supplier_id: 'SUP-005', vehicle_type: '6-Wheeler', rate: 4800.00 },
    { supplier_id: 'SUP-005', vehicle_type: '10-Wheeler', rate: 8500.00 }
  ];
  ...
  // 3. Insert Receipts (Goods Inward - SM-02)
  const receipts = [
    {
      id: 'RCT-0001',
      supplier_id: 'SUP-001',
  ...
  for (const r of receipts) {
    ...
    // Corresponding Ledger Entry for Delivery
    await dbQuery(
  ...
  // 4. Insert Advances Paid in Ledger
  const advances = [
    {
      supplier_id: 'SUP-001',
      date: '2026-07-28',
  ...
  console.log('[SEED] Database seeded with realistic Coir ERP data.');
}
