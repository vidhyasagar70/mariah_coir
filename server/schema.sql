...
CREATE TABLE IF NOT EXISTS supplier_vehicles (
    ...
    vehicle_type VARCHAR(50) NOT NULL, -- e.g., 'Pickup', '6-Wheeler', '10-Wheeler'
...
CREATE TABLE IF NOT EXISTS receipts (
    ...
    total_amount NUMERIC(10, 2) NOT NULL, -- Calculated as trip_count * rate_per_trip
...
CREATE TABLE IF NOT EXISTS settlements (
    ...
    linked_invoices TEXT[], -- Array of Receipt IDs (e.g. ['RCT-0038', 'RCT-0041'])
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
